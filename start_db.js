...
db.run(sql_hospede, err => {
    ...
    (1, 'Martin Gael Breno da Luz', 'Masculino', '00165432111', 'martin@gmail.com', '(94) 98399-5143', '1990-04-29', 'Rua 123; Casa 45 - CEP: 69077-456'),
    (2, 'Fátima Liz Eduarda', 'Feminino', '77931254287', 'jaquelinenicoledias_@vigaconstrucao.com.br', '(91) 2951-1285', '1987-01-24', 'Rua Dez 219; Casa 683 - CEP: 68515-974'),
    (3, 'Guilherme Luiz Henry Rocha', 'Masculino', '77464631773', 'guilhermeluizhenryrocha..guilhermeluizhenryrocha@sectron.com.br', '(96) 98127-4882', '1978-11-03', 'Rua Renato Russo; Casa 466 - CEP: 68909-149');`;
...
db.run(sql_hospedagem, err => {
    ...
    // Alimentation de la table
    const sql_insert = `INSERT INTO HOSPEDAGEM (id, id_hospede, id_quarto, data_inicio, data_fim, qtd_adultos, qtd_criancas, observacao, status) VALUES
    (1, 1, 1, '2022-01-01', '2022-01-01', 2, 3, 'Nenhuma obsevação', TRUE),
    (2, 2, 2, '2022-01-06', '2022-01-12', 1, 2, 'Nenhuma obsevação', TRUE),
    (3, 3, 3, '2022-11-07', '2022-11-25', 2, 5, 'Nenhuma obsevação', FALSE);`;
    db.run(sql_insert, err => {
        if (err) {
